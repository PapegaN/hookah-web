  ...
  <section class="panel">
    <div class="panel__header">
      ...
      <p class="section-copy">
        Выберите стол, добавьте до трёх вкусов и опишите пожелания. После отправки мастер или
        администратор сможет подтвердить, что вы действительно находитесь за этим столом.
      </p>
    </div>
    ...
    <label class="field">
      ...
      <textarea
        ...
        rows="4"
        placeholder="Например: хочу мягкий ягодный кальян с холодком, без тяжёлой десертности."
      />
    </label>
